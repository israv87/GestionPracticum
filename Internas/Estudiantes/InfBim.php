            ...
            <div class="full-reset nav-lateral-list-menu">
                <ul class="list-unstyled">
                    ...
                    <li><a href="RegAsis.php"><i class="zmdi zmdi-balance zmdi-hc-fw"></i>&nbsp;&nbsp; Registro de Asistencia</a></li>
                            <li><a href="#"><i class="zmdi zmdi-truck zmdi-hc-fw"></i>&nbsp;&nbsp; Informe Bimestral</a></li>
                        ...
                        <tbody>
                          <tr>                             
                            ...
                            <td class="align-middle"> <h3 >UNIVERSIDAD TECNICA PARTICULAR DE LOJA</h3>
                              <h5>Formulario de resgistro y envio del informe bimestral de las practicas pre profesionales</h5></td>
