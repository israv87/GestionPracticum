        ...
        <div class="full-reset container-menu-movile nav-lateral-scroll">
            ...
            <div class="full-reset nav-lateral-list-menu">
                <ul class="list-unstyled">
                    ...
                    <li><a href="TutorExterno/ValidarAsistencia.php"><i class=" fa fa-fw fa-calendar-check-o"></i>&nbsp;&nbsp; Validar Asistencias</a></li>
                            <li><a href="TutorExterno/Evaluacion.php"><i class="fa fa-fw fa-check-square-o"></i>&nbsp;&nbsp; Evaluación del Desempeño</a></li>
                            <li><a href="TutorExterno/ProyectosTE.php"><i class="fa fa-fw fa-suitcase"></i>&nbsp;&nbsp; Proyectos Asignados</a></li>
                            <li><a href="TutorExterno/SolicitudTE.php"><i class="fa fa-fw fa-list-alt"></i>&nbsp;&nbsp; Nuevos Proyectos</a></li>
                         
                    <li><a href="TutorExterno/Eventualidades.php"><i class="fa fa-fw fa-edit"></i>&nbsp;&nbsp; Reporte de Eventualidades</a></li> 
                </ul>
            </div>
        </div>
    </div>
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container">
            <div class="page-header">
              <h1 class="all-tittles">Tutor Externo <small>Resumen</small></h1>
            </div>
        </div>
            ...
            <div class="box-body">
              <table class="table table-bordered">
                ...
                <tr>
                  ...
                  <td><button type="button" class="btn btn-block btn-primary">Seleccionar</button></td>
                </tr>
        ...
        <div class="col-md-6">
          ...
          <div class="box box-widget widget-user-2">
            ...
            <div class="widget-user-header bg-yellow">
              ...
              <!-- /.widget-user-image -->
              <h3 class="widget-user-user-header">Proyecto ASCENDERE</h3>  
            </div>
            <div class="box-footer no-padding">
              <ul class="nav nav-stacked">
                <li><a href="#">Actividades Completadas <span class="pull-right badge bg-blue">3 / 5</span></a></li>
                <li><a href="#">Estudiantes Asignados <span class="pull-right badge bg-blue">3</span></a></li>
                <li><a href="#">Informes de actividades validiados<span class="pull-right badge bg-green">10</span></a></li>
                <li><a href="#">Evaluaciones Registradas <span class="pull-right badge bg-red">0</span></a></li>
                <li><a href="#">Eventualidades Registradas <span class="pull-right badge bg-red">0</span></a></li>
              </ul>
            </div>
          </div>
