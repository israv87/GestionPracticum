...
<head>
    ...
    <!-- Bootstrap 3.3.7 -->
    <link rel="stylesheet" href="assets/componentes/bootstrap/dist/css/bootstrap.min.css">
    <!-- Font Awesome -->
...
<div class="box box-warning">
    <div class="box-body1 box-profile" style="background:red;opacity:0.5;">
                        <img class="profile-user-img img-responsive img-circle" src="assets/imagenes/template/user01.png"
...
<div class="col-md-9">
    ...
    <!-- jQuery 3 -->
    <script src="assets/componentes/jquery/dist/jquery.min.js"></script>
    <!-- Bootstrap 3.3.7 -->
    <script src="assets/componentes/bootstrap/dist/js/bootstrap.min.js"></script>
    <!-- FastClick -->
    <script src="assets/componentes/fastclick/lib/fastclick.js"></script>
    <!-- AdminLTE App -->
    <script src="assets/componentes/adminlte.min.js"></script>
    <!-- AdminLTE for demo purposes -->
    <script src="assets/componentes/demo.js"></script>
</body>
