    ...
    <div class="navbar-lateral full-reset">
        ...
        <div class="full-reset container-menu-movile nav-lateral-scroll">
            ...
            <div class="full-reset" style="padding: 10px 0; color:#fff;">
                <figure>
                    <img src="../assets/imagenes/template/institution.png" alt="Biblioteca"
            ...
            <div class="col-sm-6">
                ...
                <div class="box-body">
                    <form role="form">
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-6">
                                    ...
                                    <div><label>Encargado</label>
                                        <input type="text" class="form-control" placeholder=""><input type="reset"
                                            value="Editar">
                                    </div>
                                ...
                                <div class="col-xs-12 col-sm-6">
                                    ...
                                    <input type="file" name="archivo" title="Cronograma" id="importData"
                                        accept=".xls,.xlsx" />
                        ...
                        <div id="estadodeproyectos" style="display: none">
                            <div class="container">
                                <div class="page-header">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="align-middle"><img
                                                            src="../../assets/imagenes/utpl_logo1.png"
                                                            style="width: 90%;"></td>
                                                    <td class="align-middle">
                                                        <h3>UNIVERSIDAD TECNICA PARTICULAR DE LOJA</h3>
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <td> 2 </td>
                                        <td> <span class="label label-success">Validado</span>
                                            <td />
                            ...
                            <form role="form">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-check">
                                        ...
                                        <button type="Submit"
                                            class="btn btn-block btn-default bg-blue">Solicitar</button>
                                    </div>
                                </div>
                                <?php
